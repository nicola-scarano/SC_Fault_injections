...
from pytorchfi.FI_Weights_segmentation import FI_manager 
from pytorchfi.FI_Weights_segmentation import DatasetSampling 
...
def main(args):
    ...
    subsampler = DatasetSampling(test_data_loader.dataset,3)
    ...
    if args.fsim_config:
        ...
        for fault,k in tqdm(FI_setup.iter_fault_list()):
            ...
            try:
                ...
                start = time.time()
                evaluate(FI_setup.FI_framework.faulty_model, dataloader, device, device_ids, distributed, num_classes, no_dp_eval=no_dp_eval,
