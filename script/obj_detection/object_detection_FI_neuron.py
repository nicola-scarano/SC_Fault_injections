...
def evaluate(model_wo_ddp, data_loader, iou_types, device, device_ids, distributed, no_dp_eval=False,
    ...
    for sample_batch, targets in metric_logger.log_every(data_loader, log_freq, header):
        ...
        # len = 1
        # new_model = torch.load("/home/g.esposito/sc2-benchmark/resource/ckpt/coco2017/supervised_compression/ghnd-bq/coco2017-faster_rcnn_resnet50-bq1ch_fpn_from_faster_rcnn_resnet50_fpn.pt")
