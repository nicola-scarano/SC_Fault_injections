...
from pytorchfi.FI_Weights_classification import *
...
def main(args):
    ...
    name_config=f"FSIM_logs_debug/{name_config}_{conf_fault_dict['mode_inj']}_{conf_fault_dict['layer']}"
    ...
    #weight_distribution(FI_setup.FI_framework.pfi_model,layer=conf_fault_dict['layer'],path=FI_setup.log_path)
